...
def save_imgs(img_floder,label_floder,save_img_path,save_label_path,l):
    y_min,y_max,x_min,x_max=l
...
if __name__=='__main__':
    ...
    # img_floder='../preprocess-npz-data/test/image'
    ...
    #
    # train_img_floder = '../preprocess-npz-data/train/image'
    # train_label_floder = '../preprocess-npz-data/train/label'
    # train_save_img_path = 'D:/zhiwensuo/pytorch/project/data_Naso_crop2/train/image'
    # train_save_label_path = '../data_Naso_crop2/train/label'
    # train_save_edge_path='../data_Naso_crop2/train/edge'
    #
    ...
    # save_imgs(img_floder,label_floder,save_img_path,save_label_path,l)
    # save_imgs(train_img_floder, train_label_floder, train_save_img_path, train_save_label_path, l)
