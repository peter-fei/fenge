...
from net.wider_resnet import wider_resnet38_a2
from torch.autograd import Variable

from net import GatedSpatialConv as gsc
...
class GSCNN(nn.Module):
    ...
    def __init__(self, num_classes, trunk=None, criterion=None):
        ...
        self.mod1 = wide_resnet.model.mod1
        self.mod2 = wide_resnet.model.mod2
        self.mod3 = wide_resnet.model.mod3
        self.mod4 = wide_resnet.model.mod4
        self.mod5 = wide_resnet.model.mod5
        self.mod6 = wide_resnet.model.mod6
        self.mod7 = wide_resnet.model.mod7
        self.pool2 = wide_resnet.model.pool2
        self.pool3 = wide_resnet.model.pool3
    ...
    def forward(self, inp, gts=None,train=False):
