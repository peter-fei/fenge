...
class M4(Module):
    def __init__(self,inchannels,out_channels,filters=(64,128,256,512,1024)):
        ...
        self.up_conv5_4=Up_Conv_scal(cat_channel*5,cat_channel,stride=2)
    ...
    def forward(self, x, train=False):
        ...
        a1=self.relu(a1_4+a1_3+a1_2+a1_5+hd1)
        out=self.out(a1)

        edge2_out=self.edge_up2(edge2)
        edge3_out=self.edge_up3(edge3)
        edge4_out=self.edge_up4(edge4)
