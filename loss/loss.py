...
def get_loss(num_classes=2,ignore_label=255,wt_bound=1,edge_weight=1,seg_weight=1,att_weight=1,dual_weight=1):
    '''
    ...
    #    ignore_index=ignore_label, upper_bound=wt_bound,
    #    edge_weight=edge_weight, seg_weight=seg_weight, att_weight=att_weight, dual_weight=dual_weight).cuda()
    #


    criterion_val = JointEdgeSegLoss(classes=num_classes, mode='val',
       ignore_index=ignore_label, upper_bound=wt_bound,
       edge_weight=edge_weight, seg_weight=seg_weight).cuda()
...
class ImageBasedCrossEntropyLoss2d(nn.Module):
    ...
    def __init__(self, classes, weight=None, size_average=True, ignore_index=255,
                 norm=False, upper_bound=1.0,BATCH_WEIGHTING=False):
        ...
        self.batch_weights = BATCH_WEIGHTING
